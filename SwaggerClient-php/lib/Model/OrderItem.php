...
class OrderItem implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["EACH", "HOURS", "DAYS", "SECONDS", "CRATE_OF_12", "SIX_PACK", "GALLON", "LITRE"];
        if (!in_array($this->container['unit_of_measure'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'unit_of_measure', must be one of 'EACH', 'HOURS', 'DAYS', 'SECONDS', 'CRATE_OF_12', 'SIX_PACK', 'GALLON', 'LITRE'.";
        }
